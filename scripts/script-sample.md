...
Currently the native-Div-into-LaTeX-environment processing is glitchy. You can use raw LaTeX as here so that you can continue to do other markdown things where you wish.
...
I suggest including a note to yourself in the script that material has been omitted, or this can look pretty funny. 
